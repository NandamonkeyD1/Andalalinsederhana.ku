...
var dataCek = {
  pusat_kegiatan: [
    {
      value: 'perdagangan',
      label: 'Kegiatan perdagangan dan perbelanjaan',
      ukuran: [
    ...
    {
      value: 'industri',
      label: 'Kegiatan Industri dan Pergudangan',
  ...
  permukiman: [
    {
      value: 'perumahan',
      label: 'Perumahan dan permukiman',
      ukuran: [
